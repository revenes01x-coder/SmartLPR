...
CAPTURE_EVENT_SECRET = _require("CAPTURE_EVENT_SECRET")

ADMIN_AUDIT_LOG_RETENTION_DAYS = int(os.getenv("ADMIN_AUDIT_LOG_RETENTION_DAYS", "365"))

# ---- Camera AI Worker ----
CAMERA_DETECTION_FPS = float(os.getenv("CAMERA_DETECTION_FPS", "5.0"))
