...
async def list_my_webhooks(
    ...
    if order == "asc":
        query = query.order_by(models.WebhookEndpoint.created_at.asc(), models.WebhookEndpoint.id.asc())
    else:
        query = query.order_by(models.WebhookEndpoint.created_at.desc(), models.WebhookEndpoint.id.desc())
